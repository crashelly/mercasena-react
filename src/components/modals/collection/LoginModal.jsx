            ...
            <dialog id="LoginModal" className="modal ">
                <div className="modal-box bg-white">
                    <form method="dialog">
                        ...
                        <button className="btn text-black text-2xl hover:bg-red-600  transition-colors  hover:duration-300 btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                    </form>
                    <div className="mt-6">
                        <div
                            ...
                            <div className="bg-white px-8 py-10">
                                ...
                                >
                                    ...
                                    <div className="text-center text-white">
                                        ...
                                        <h2 className="text-2xl font-extrabold" >MERCASENA
                                        </h2>
                                    </div>
                                </div>
