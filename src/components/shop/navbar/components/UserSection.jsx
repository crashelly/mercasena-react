...
export const UserSection = () => {
    ...
    return (
        <>
            ...
            {/* icono de la persona */}
            <div className="order-4 md:order-4 md:inset-y-0 md:right-0  bg-white ml-1 md:ml-4 md:mr-2 mt-0 flex items-center justify-end md:space-x-4 mr-0" id="nav-content">
                                    ...
                                    user.isLoggedIn ? (
                                        <>
                                            <div tabIndex="0" role="button" id="loginTrigger"
                                                class="btn bg-white hover:bg-slate-100 border-0 hover:shadow-md shadow-none  color-sena-texto    md:text-md  m-1">
                                                {/* icono del usuario */}
                                                <a href="index.html" className="hidden hover:animate-bounce hover:animate-ease-in-out mr-4 color-sena-texto  md:inline-block no-underline  text-green-600" >
                                            ...
                                            <ul tabindex="0" class=" mt-13 dropdown-content menu bg-white rounded-box z-1 w-70 p-2 shadow-sm">

                                                {
                                                    <>
                                                        <MenuOption icon={menuOptions.account.icon} description={menuOptions.account.description} />
                                                        <MenuOption icon={menuOptions.orders.icon} description={menuOptions.orders.description} />
                                                        <MenuOption icon={menuOptions.bills.icon} description={menuOptions.bills.description} />
                                                        <MenuOption icon={menuOptions.logOut.icon} description={menuOptions.logOut.description} />
                                                    </>
                ...
                <div className="ml-3  border-l-2 hidden  md:block  border-green-500 h-6"></div>
    ...
    account: {
        ...
        icon: () => (
            <svg width="30px" height="30px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#39A900">
                <g id="SVGRepo_bgCarrier" stokeWidth="0"></g>
            ...
            <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="SVGRepo_iconCarrier">
                    <path
                        ...
                        stroke="#39A900" strokeWidth="2" stroke-linejoin="round"></path>
                    <path d="M9 11V5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5V11" stroke="#39A900"
                        stokeWidth="2" strokeLinecap="round" stroke-linejoin="round"></path>
                </g>
            </svg>
        )
    },
            ...
            <svg stroke="#39A900" width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                ...
                <g id="SVGRepo_iconCarrier">
                    <path
                        ...
                        stroke="#39A900" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round"></path>
                </g>
            </svg>
        )
    }
